...
THREE.VREffect = function (renderer, onError) {
    ...
    let headMatrix = new THREE.Matrix4();
    let eyeMatrixL = new THREE.Matrix4();
    let eyeMatrixR = new THREE.Matrix4();
    ...
    let defaultLeftBounds = [0.0, 0.0, 0.5, 1.0];
    let defaultRightBounds = [0.5, 0.0, 0.5, 1.0];

    function onVRDisplayPresentChange() {
        let wasPresenting = scope.isPresenting;
    ...
    let poseOrientation = new THREE.Quaternion();
    let posePosition = new THREE.Vector3();
